...
$AppNameAzure = "AzureSentinel and LogAnalytics Client for Enterprise Alert"
$AzureRoleName = "Access to Azure Sentinel and Log Analytics API for 3rd party systems";
